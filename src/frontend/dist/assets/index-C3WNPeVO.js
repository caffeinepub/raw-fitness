...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontSize: "2rem", marginBottom: "1rem", color: "#fff" }, children: "Site Not Available" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "1rem", maxWidth: "400px" }, children: "This site is currently unavailable. Please check back later." })
      ]
    }
  );
}
...
Service({
  ...
  "getMembershipPlanById": Func(
    [Nat],
    [Opt(MembershipPlan)],
    ["query"]
  ),
  "getMembershipPlans": Func([], [Vec(MembershipPlan)], ["query"]),
  "getTrainerById": Func([Nat], [Opt(Trainer)], ["query"]),
  "getTrainers": Func([], [Vec(Trainer)], ["query"]),
  "getTransformationById": Func(
    [Nat],
    [Opt(Transformation)],
    ["query"]
  ),
  "getTransformations": Func([], [Vec(Transformation)], ["query"]),
  "getUserProfile": Func(
    [Principal2],
    [Opt(UserProfile)],
    ["query"]
  ),
  "initializeDefaultData": Func([], [], []),
